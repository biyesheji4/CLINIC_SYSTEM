...
<div class="container secondary ">
    <div>
        ...
        <span>当前位置：诊疗方案收费</span>
    </div>
    <div class="filter">
        <ul>
            <li>
                <label>诊疗药品or诊疗方案:</label>
                <select id="programmetype">
                    <option value="programme_medicine">诊疗药品</option>
                    <option value="programme_project">诊疗方案</option>
                </select>
            </li>
            <li>
                <label>诊疗方案是否缴费:</label>
                <select id="state">
                    <option value="0">未缴费</option>
                    <option value="1">已缴费</option>
                    <option value="2">已取药or已检查</option>
                </select>
            </li>
            <li>
                <label>选择时间:</label>
...
<script src="${pageContext.request.contextPath}/js/charges.js"></script>
